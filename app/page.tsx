        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <RevealSection className="group relative" delay={100}>
              <SectionLink href="/services#data-mastery" className="absolute inset-0 z-10">
            ...
            <RevealSection className="group relative" delay={200}>
              <SectionLink href="/services#cognitive-system" className="absolute inset-0 z-10">
            ...
            <RevealSection className="group relative" delay={300}>
              <SectionLink href="/services#ecosystem-architecture" className="absolute inset-0 z-10">
